        ...
        <div class="template-example">
          ...
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <?php
              $conn = mysqli_connect("localhost", "root", "", "Estacion");
              // Check connection
              if ($conn->connect_error) {
              die("Connection failed: " . $conn->connect_error);
              }
              $sql = "SELECT idMedicion, temperatura, fecha FROM Mediciones";
              $result = $conn->query($sql);
              if ($result->num_rows > 0) {
              // output data of each row
              while($row = $result->fetch_assoc()) {
              echo "<tr><td>" . $row["idMedicion"]. "</td><td>" . $row["temperatura"] . "</td><td>"
              . $row["fecha"]. "</td></tr>";
              }
              echo "</table>";
              } else { echo "0 results"; }
